...
pub const INTERNAL_URL_CONNECTION_CLASS: &str =
    "io/kyle/javaguard/support/InternalResourceURLConnection";
...
pub const RESOURCE_DECRYPT_NATIVE_CLASS: &str =
    "io/kyle/javaguard/support/InternalResourceDecryptInputStream";
